...
Wrappers
--------
Controllers should only return an HTML fragment. Wrapping that fragment into the full site layout should be accomplished through wrappers, although wrappers can have other uses.
