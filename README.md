...
9. [Bindings](#bindings)
    ...
    9.2. [Bindings VS accessing superglobal arrays](#bindings-vs-accessing-superglobal-arrays)
10. [Reverse routing](#reverse-routing)
11. [Wrappers](#wrappers)
    11.1. [Resources](#resources)
    11.2. [Wrappers](#wrappers)
    11.3. [Examples](#examples)
        11.3.1. [Website layout](#website-layout)
        11.3.2. [Authorizations](#authorizations)
...
14. [Templating system](#templating-system)
    14.1. [Echo VS return](#echo-VS-return)
    14.2. [Views](#Views)
    14.3. [Page](#Page)
